...
\begin{ganttchart}[
  ...
  \ganttgroup[progress=100]{Add questions}{1}{1} \\
  
  \ganttgroup[progress=75]{Set up API and test}{7}{11} \\
  
  \ganttbar[
    progress=100
  ]{\textbf{4.1} Login/signup}{7}{7} \\
  
  \ganttbar[
    progress=100
  ]{\textbf{4.2} List concepts}{7}{7} \\
  
  \ganttbar[
    progress=100
  ]{\textbf{4.3} Submit responses}{8}{8} \\
  
  \ganttbar[
    progress=0
  ]{\textbf{4.4} Fetch question}{8}{9} \\
  
  \ganttbar[
    progress=0
  ]{\textbf{4.5} Return probabilities}{10}{11} \\
...
\begin{ganttchart}[
	...
	% PART 2: Landing page
	\ganttgroup[progress=100]{Landing Page}{3}{3} \\
	
	\ganttgroup[progress=50]{ITS}{6}{14} \\
